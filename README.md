...
- `/tts browse` — browse Kokoro voices interactively, hearing each as you select it, then save it globally (`s`) or for this project (`p`); arrow keys or mouse (`~/.claude/skills/tts/browse-voices.sh`)
